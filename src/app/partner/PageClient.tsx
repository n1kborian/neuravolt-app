...
const vorteile = [
  { icon: Inbox,         title: "Aufträge direkt ins Postfach",  desc: "Du erhältst passende DGUV V3 Prüfaufträge aus deiner Region — kuratiert und vollständig vorbereitet. Kein Akquise-Aufwand, kein Kaltakquirieren." },
  { icon: CalendarCheck, title: "Flexible Auftragsplanung",      desc: "Du entscheidest selbst, welche Aufträge du annimmst. Lange Vorlaufzeiten geben dir die Möglichkeit, dein Auftragsbuch entspannt und optimal zu planen." },
  { icon: ShieldCheck,   title: "Null Management-Overhead",      desc: "Terminkoordination, Kundenkommunikation, Rechnungsstellung, Protokoll-Versand — das alles übernimmt NeuraVolt vollautomatisch. Du prüfst. Wir erledigen den Rest." },
  { icon: Zap,           title: "Vollautomatisiertes Backoffice", desc: "Unsere KI-gestützte Plattform verwaltet Fristen, Dokumentation und Kundendaten nahezu ohne manuellen Eingriff — maximale Effizienz für dich und deine Kunden." },
  { icon: BarChart3,     title: "Transparente Auftragslage",     desc: "Dein persönliches Partner-Dashboard zeigt dir jederzeit offene Aufträge, Termine und Abrechnungen auf einen Blick. Kein Papierkram, alles digital." },
  { icon: HeadphonesIcon,title: "Persönlicher Ansprechpartner",  desc: "Bei Fragen steht dir ein fester Ansprechpartner bei NeuraVolt zur Seite — einer, der dein Unternehmen kennt und immer erreichbar ist." },
];
...
const schritte = [
  ...
  { step: "02", title: "Onboarding & Freischaltung", desc: "Nach einem kurzen Onboarding erhältst du Zugang zu deinem Partner-Dashboard und wirst in unser Partnernetzwerk aufgenommen." },
  { step: "03", title: "Aufträge auswählen",         desc: "Du siehst verfügbare Aufträge in deiner Region und wählst flexibel aus, was zu deinem Kalender passt — mit ausreichend Vorlaufzeit." },
  { step: "04", title: "Prüfen & kassieren",         desc: "Du führst die Prüfung durch, lädst das Protokoll hoch — wir erledigen Abrechnung, Kundenkommunikation und Dokumentation vollautomatisch." },
];
...
const fakten = [
  ...
  { num: "0",     label: "Akquise-Aufwand",            sub: "Aufträge kommen zu dir" },
  { num: "1",     label: "Fester Ansprechpartner",     sub: "Der dein Unternehmen kennt" },
];
        ...
        <section ref={vorteileRef} className="w-full py-16 md:py-20">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="h-[2px] w-8 bg-foreground" />
                <span className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground">Deine Vorteile</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground leading-tight mb-3">
                Du prüfst. Wir übernehmen den Rest.
              </h2>
              <p className="text-muted-foreground text-lg max-w-2xl">
                Als NeuraVolt-Partner konzentrierst du dich ausschließlich auf die Prüftätigkeit — alles drumherum läuft vollautomatisch.
              </p>
            </motion.div>
