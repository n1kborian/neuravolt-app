          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl sm:text-2xl font-semibold text-foreground leading-relaxed mb-6">
                &ldquo;Kein Koordinationsaufwand, keine Papierprotokolle, keine Fristenverfolgung. NeuraVolt bündelt Aufträge über unser Partnernetzwerk und gibt den Effizienzvorteil direkt an Sie weiter — automatisch, ab dem ersten Prüfauftrag.&rdquo;
              </p>
