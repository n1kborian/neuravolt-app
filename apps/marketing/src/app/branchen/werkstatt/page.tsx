...
export default function WerkstattPruefungPage() {
  return (
    <BranchenPageTemplate
      ...
      image="https://images.pexels.com/photos/3807319/pexels-photo-3807319.jpeg?auto=compress&cs=tinysrgb&w=800"
      imageAlt="Handwerker in der Werkstatt – DGUV V3 Prüfung"
    />
  );
}
